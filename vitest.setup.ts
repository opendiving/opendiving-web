...
// months with `Element.animate`. The stub is finished on arrival - which is
// what the component's "is a slide still running" guard reads - and that is the
// right answer for a test asking which month is on screen rather than how it
// got there. The sliding itself is a browser's to show.
