...
// its own bundles; the route fallback passes none and gets these, which is the
...
export interface GearPageFrameProps {
  ...
  /** Opens the new-gear dialog. Absent in the fallback, which has none to open. */
  onNew?: () => void;
  /** The page watches this box to decide when to ask for the sets. */
  setsCardRef?: Ref<HTMLDivElement>;
}

// Everything /gear draws before either list exists, rendered by the page and by
