      ...
      <CardContent className="flex flex-col flex-1">
        ...
        >
          <div className="space-y-4 flex-1">
            ...
            {sentTo && (
              <div className="flex items-start gap-2 p-3 text-sm text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/40 rounded-md border border-green-200 dark:border-green-900">
