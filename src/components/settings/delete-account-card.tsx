  ...
  return (
    <Card>
      ...
      <CardContent>
        <div className="rounded-md border border-destructive/40 bg-destructive/10 p-4">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            ...
            contacts and profile are then erased for good once this
      ...
      <ConfirmDialog
        ...
        description="This erases your whole logbook: every dive and its profile, your dive sites, trips, gear and service history, your courses, your certifications and the scans of your cards, your contacts, and the dive-computer files you imported. Take a copy first if you might want any of it - afterwards there is nowhere to take it from."
