...
/**
 * The Google Play "colored triangle" logo mark, as used on the "Get it on
 * Google Play" badge. Path data from Wikimedia Commons
 * (https://commons.wikimedia.org/wiki/File:Google_Play_Arrow_logo.svg,
 * public domain trademark artwork), unmodified. Unlike most icons in this
