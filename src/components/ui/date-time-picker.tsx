...
export function DateTimePicker({
  ...
  const [minutes, setMinutes] = React.useState(pad(selectedDate?.getMinutes() ?? 0))
  const [seconds, setSeconds] = React.useState(pad(selectedDate?.getSeconds() ?? 0))
  ...
  const handleTimeChange = (part: "hours" | "minutes" | "seconds", rawValue: string) => {
