 ...
 *
 * **Every sentence here has to be true of a household instance as well as a
 * hosted one.** The same copy renders for somebody sharing a copy of OpenDiving
 * with three dive buddies, so there is no "beta", no "we", and no promise that an
 * invitation is coming - the operator decides who is invited and when, and this
 * form can only say so.
 *
 ...
 * informative than that: one success state, whatever was stored.
 *
 ...
 */
export function InviteRequestForm({ className }: InviteRequestFormProps) {
      ...
      {requested ? (
        ...
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            If an invitation comes your way it will arrive at{" "}
            <span className="font-medium text-foreground">{requested}</span>.
            Whoever runs this instance decides who is invited, and when.
          </p>
        </div>
      ) : (
        <>
          <div className="mb-4 text-left">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              This instance is not taking new accounts on its own. Leave your
              address and whoever runs it can invite you.
            </p>
          </div>
