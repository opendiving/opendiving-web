          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                OpenDiving ("we," "our," or "us") is committed to protecting
              ...
              <p className="text-gray-700 mb-4">
                ...
                control over personal data. This policy outlines our practices
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                ...
                <li>
                  <strong>Communication:</strong> Messages, comments, and posts
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                ...
                <li>
                  <strong>Safety:</strong> Monitor for dangerous diving
                  practices or inappropriate content
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">You can control:</p>
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                ...
                <li>
                  Legal or safety-related data may be retained as required
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                countries where our servers and service providers are located.
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Users between 13-18 should have parental consent before using
                our Service, especially given the nature of diving activities.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                ...
                <li>
                  Community members can contribute to privacy improvements
                </li>
                <li>
                  Data handling practices are documented in our repository
                </li>
              </ul>
            </section>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <p className="text-sm text-gray-500">
                This Privacy Policy is effective as of September 2025 and
                applies to all users of OpenDiving.
              </p>
              <Link
                href="/"
