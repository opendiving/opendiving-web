...
**email conduct@opendiving.app**. Reports are read only by the project maintainers, who act as the
Community Moderators referred to below. Include what happened, where, and any links or screenshots
that help — you do not need to be certain a violation occurred to report one.

If your report concerns a maintainer, you may instead report the account or content directly to
GitHub at <https://github.com/contact/report-abuse>.
